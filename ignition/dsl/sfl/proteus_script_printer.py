...
\"\"\"Proteus Script generated by Ignition

Basic solution for %(expr)s.
\"\"\"
...
problem_template = """
class MyProblem(ProteusProblem):
...
numeric_template = """
class C0P1_Numerics(ProteusNumerics):
...
def main(*args):
    ...
    problem_list = [MyProblem(),]
    simulation_list = [default_s]
    numerics_list = [C0P1_Numerics(),]
...
class ProteusScriptPrinter(SFLPrinter):
    ...
    def _print_problem_class(self, indent):
        ret_code = problem_template % {'coefficient_class': self._generator.coefficient_class,
                                       }
        return ret_code
